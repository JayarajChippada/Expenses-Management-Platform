...
incomeService.deleteIncome = async (userId, incomeId) => {
  try {
    const resObj = await incomeModel.deleteOne({
      _id: incomeId,
      userId: userId,
    });
...
incomeService.fetchIncomesByCategory = async (
  userId,
  categoryName,
  page = 1,
  limit = 10
  ...
  try {
    ...
    console.log(
      "Income Service fetchIncomesByCategory() method Error: ",
      error
    );
    throw error;
  }
...
incomeService.fetchIncomesByDate = async (
  userId,
  startDate,
  endDate,
  page = 1,
...
incomeService.fetchIncomesBySearch = async (
  userId,
  search,
  page = 1,
  limit = 10
