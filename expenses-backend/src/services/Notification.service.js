...
notificationService.createNotification = async (
  ...
  try {
    ...
    console.log(
      "Notification Service createNotification() method Error: ",
      error
    );
...
notificationService.fetchNotifications = async (userId) => {
  try {
    ...
    console.log(
      "Notification Service fetchNotifications() method Error: ",
      error
    );
    throw error;
  }
...
notificationService.deleteNotification = async (userId, notificationId) => {
  try {
    ...
    console.log(
      "Notification Service deleteNotification() method Error: ",
      error
    );
    throw error;
  }
