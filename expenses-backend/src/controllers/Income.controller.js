...
incomeController.fetchIncomesByUserId = async (req, res, next) => {
    try {
        ...
        console.log("Income Controller fetchIncomesByUserId() method Error: ", error);
        next(error);
    }
};
...
incomeController.fetchIncomesByCategory = async (req, res, next) => {
    try {
        ...
        const result = await incomeService.fetchIncomesByCategory(userId, categoryName, page, limit);
...
incomeController.fetchIncomesByDate = async (req, res, next) => {
    try {
        ...
        const result = await incomeService.fetchIncomesByDate(userId, dateObj.startDate, dateObj.endDate, page, limit);
...
incomeController.fetchIncomesBySearch = async (req, res, next) => {
    try {
        ...
        const result = await incomeService.fetchIncomesBySearch(userId, search, page, limit);
