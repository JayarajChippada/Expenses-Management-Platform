      ...
      <div className="card-body p-4">
        <div className="d-flex justify-content-between align-items-start mb-3">
          <div className="flex-grow-1">
            ...
            <span className="badge rounded-pill fw-medium border border-light-subtle extra-small text-muted bg-light">
              <i
                className="bi bi-tag-fill me-1"
                style={{ color: getCategoryColor(goal.categoryName) }}
              ></i>
              {goal.categoryName}
            </span>
          </div>
          ...
          >
            <div
              className={`progress-bar rounded-pill ${
                isCompleted ? "bg-success" : "bg-primary-custom"
              }`}
              role="progressbar"
              style={{
                width: `${percentage}%`,
        ...
        <div className="row g-2 mb-3">
          <div className="col-4">
            <div className="text-muted extra-small text-uppercase fw-bold opacity-75">
              Saved
            </div>
